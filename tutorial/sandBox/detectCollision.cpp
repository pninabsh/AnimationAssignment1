...
bool search_collided_boxes_in_trees(igl::opengl::ViewerData collider1, igl::AABB<Eigen::MatrixXd, 3> node1, std::vector< Eigen::AlignedBox<double, 3>>& collided_boxes_collider1,
	...
	if (node1.is_leaf() && node2.is_leaf()) {
		...
		if (detect_collision(collider1, node1.m_box, collider2, (*node2.m_right).m_box)) {
			collide = search_collided_boxes_in_trees(collider1, node1, collided_boxes_collider1, collider2, *(node2.m_right), collided_boxes_collider2);
			if (collide) {
				return true;
			}
		}
		if (detect_collision(collider1, node1.m_box, collider2, (*node2.m_left).m_box)) {
			collide = search_collided_boxes_in_trees(collider1, node1, collided_boxes_collider1, collider2, *(node2.m_left), collided_boxes_collider2);
			if (collide) {
				return true;
			}
		}
		...
		if (detect_collision(collider1, (*node1.m_right).m_box, collider2, node2.m_box)) {
			collide = search_collided_boxes_in_trees(collider1, (*node1.m_right), collided_boxes_collider1, collider2, node2, collided_boxes_collider2);
			if (collide) {
				return true;
			}
		}
		if (detect_collision(collider1, (*node1.m_left).m_box, collider2, node2.m_box)) {
			collide = search_collided_boxes_in_trees(collider1, (*node1.m_left), collided_boxes_collider1, collider2, node2, collided_boxes_collider2);
			if (collide) {
				return true;
			}
		}
		...
		if (detect_collision(collider1, (*node1.m_left).m_box, collider2, (*node2.m_left).m_box)) {
			collide = search_collided_boxes_in_trees(collider1, (*node1.m_left), collided_boxes_collider1, collider2, (*node2.m_left), collided_boxes_collider2);
			if (collide) {
				return true;
			}
		}
		if (detect_collision(collider1, (*node1.m_right).m_box, collider2, (*node2.m_left).m_box)) {
			collide = search_collided_boxes_in_trees(collider1, (*node1.m_right), collided_boxes_collider1, collider2, (*node2.m_left), collided_boxes_collider2);
			if (collide) {
				return true;
			}
		}
		if (detect_collision(collider1, (*node1.m_left).m_box, collider2, (*node2.m_right).m_box)) {
			collide = search_collided_boxes_in_trees(collider1, (*node1.m_left), collided_boxes_collider1, collider2, (*node2.m_right), collided_boxes_collider2);
			if (collide) {
				return true;
			}
		}
		if (detect_collision(collider1, (*node1.m_right).m_box, collider2, (*node2.m_right).m_box)) {
			collide = search_collided_boxes_in_trees(collider1, (*node1.m_right), collided_boxes_collider1, collider2, (*node2.m_right), collided_boxes_collider2);
			if (collide) {
				return true;
			}
		}
...
bool find_collided_boxes(igl::opengl::ViewerData &collider1, igl::opengl::ViewerData &collider2) {
	...
	if (!search_collided_boxes_in_trees(collider1, collider1.kd_tree, collided_boxes_object.collided_boxes_collider1,
